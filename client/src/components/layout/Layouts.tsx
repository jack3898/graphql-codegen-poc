...
export function BentoFullLayout({
  ...
  return (
    <div
      className={`grid size-full grid-cols-[auto_1fr_1fr_auto] grid-rows-[auto_1fr_1fr_auto] gap-2 [grid-template-areas:'header_header_header_header''left_center_center_right''left_center_center_right''bottom_bottom_bottom_bottom']`}
    >
